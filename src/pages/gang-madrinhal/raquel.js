...
class RaquelText extends React.Component {
    ...
    render() {
        return <div className={styles.description}>
            ...
            <p>Em Maio de 2019 a Isabel nunca poderia casar sem a sua Raquel do seu lado (a Margarida para a sua Minnie), como sempre esteve desde 1989.</p>
